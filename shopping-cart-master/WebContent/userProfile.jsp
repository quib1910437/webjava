...
<body style="background-color: #e6f8f9;">
	...
	if (user == null)
		user = new UserBean("Test User", 98765498765L, "test@gmail.com", "Can Tho, Viet Nam", 87659, "lksdjf");
	%>
